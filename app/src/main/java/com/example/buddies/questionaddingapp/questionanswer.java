    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mques= FirebaseDatabase.getInstance().getReference().child("Movies");
                mq= mques.child(""+a);
                ...
                t4.setText("");
                t5.setText("");
                Toast.makeText(questionanswer.this,"Question Added Successfully to the Firebase Database!",Toast.LENGTH_LONG).show();
